/*
 ...
 Date: 05/05/2014 16:56:02 PM
*/

-- ----------------------------
--  Sequence structure for notifications_notificationid_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sidebar"."notifications_notificationid_seq";
CREATE SEQUENCE "sidebar"."notifications_notificationid_seq" INCREMENT 1 START 1 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "sidebar"."notifications_notificationid_seq" OWNER TO "sidebar";

-- ----------------------------
--  Sequence structure for urls_urlid_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sidebar"."urls_urlid_seq";
CREATE SEQUENCE "sidebar"."urls_urlid_seq" INCREMENT 1 START 44 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
ALTER TABLE "sidebar"."urls_urlid_seq" OWNER TO "sidebar";

-- ----------------------------
--  Sequence structure for users_userid_seq
-- ----------------------------
DROP SEQUENCE IF EXISTS "sidebar"."users_userid_seq";
CREATE SEQUENCE "sidebar"."users_userid_seq" INCREMENT 1 START 20 MAXVALUE 9223372036854775807 MINVALUE 1 CACHE 1;
...
INSERT INTO "sidebar"."url_categories" VALUES ('45', 'search', 'blank', 'blank', 'blank', 'blank', '0.100000');
COMMIT;
...
CREATE TABLE "sidebar"."urls" (
	"urlid" int4 NOT NULL DEFAULT nextval('urls_urlid_seq'::regclass),
...
-- ----------------------------
BEGIN;
INSERT INTO "sidebar"."dancecard" VALUES ('23', '11', 'added', 't', '2014-05-05 16:33:11');
COMMIT;
...
-- ----------------------------
--  Function structure for sidebar.check_mutual(int4, int4)
-- ----------------------------
DROP FUNCTION IF EXISTS "sidebar"."check_mutual"(int4, int4);
CREATE FUNCTION "sidebar"."check_mutual"(IN userid1 int4, IN userid2 int4) RETURNS "bool"
	AS $BODY$
DECLARE
	count int;
BEGIN
...
$BODY$
	...
	SECURITY INVOKER
	VOLATILE;
ALTER FUNCTION "sidebar"."check_mutual"(IN userid1 int4, IN userid2 int4) OWNER TO "sidebar";


-- ----------------------------
--  Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "sidebar"."notifications_notificationid_seq" RESTART 2 OWNED BY "notifications"."notificationid";
ALTER SEQUENCE "sidebar"."urls_urlid_seq" RESTART 45 OWNED BY "urls"."urlid";
ALTER SEQUENCE "sidebar"."users_userid_seq" RESTART 21 OWNED BY "users"."userid";
-- ----------------------------
